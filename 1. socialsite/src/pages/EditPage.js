...
const EditPage = () => {
  ...
  if (
    document.querySelector(".profile_detail_box").classList.contains("appire")
  ) {
          ...
          <div className="post_bottom modyfy_post_bottom">
            <div className="post_title_tags">
              ...
              <div className="post_bottom_ modify_post_bottom_">
                <Link className="edit_" to={"/edit_form/" + post.id}>
                  Edit
                </Link>
                <a onClick={sendDeleteReq} className="Delete_">
                  Delete
                </a>
                <a className="edit_" href="#">
                  Pin to profile
                </a>
                <a className="edit_" href="#">
                  Stats
